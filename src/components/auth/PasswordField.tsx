    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className={className ? `${className} pr-12` : `
        ...
        <button
          ...
          className={`absolute inset-y-0 right-0 flex items-center transition-colors ${
            className 
              ? 'pr-4 text-gray-500 dark:text-white/60 hover:text-gray-700 dark:hover:text-white/80' 
              : 'pr-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'
          }`}
        >
